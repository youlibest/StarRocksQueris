...
type DBConfig struct {
	...
	SlowQueryWecomWebhookKey               string    `bson:"slow_query_wecom_webhook_key"`
	SlowQueryWecomMsgType                  string    `bson:"slow_query_wecom_msg_type"`
	SlowQueryWecomMentionAll               int       `bson:"slow_query_wecom_mention_all"`
	SlowQueryWecomStatus                   int       `bson:"slow_query_wecom_status"`
